...
const timelineEvents = [
  {
    ...
    description: "Led development of enterprise-level applications using React, Node.js, and AWS.",
  ...
  },
  {
    ...
    description: "Started career as a junior developer working on frontend projects.",
