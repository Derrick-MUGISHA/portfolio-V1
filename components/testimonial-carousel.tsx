...
const testimonials = [
  {
    id: 1,
    name: "KENT",
    role: "Full stack developer, Vidaripay",
  ...
  },
  {
    id: 2,
    name: "Kevin",
    role: "Product Manager, Vidaripay",
    image: "/placeholder.svg?height=100&width=100",
    content:
  ...
  },
  {
    id: 3,
    name: "Eric Hirwa",
    role: "Full stack developer, sonarwa insurance",
    image: "/placeholder.svg?height=100&width=100",
    content:
      "We Worked with DERRICK MUGISHA to rebuild our company website and the results were outstanding. His technical skills combined with an eye for design created a website that perfectly represents our brand and has significantly improved our conversion rates.",
    rating: 5,
  },
  {
    id: 4,
