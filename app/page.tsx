  ...
  <div className="max-w-4xl mx-auto">
    ...
    >
      ...
      <section ref={scrollRef} className="py-24 bg-black/80 backdrop-blur-md">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">My Services</h2>
            <p className="text-xl text-white/70">
              I offer a wide range of services to help businesses and individuals achieve their digital goals.
              <span className="block mt-2 text-blue-400 font-mono text-base">function solveYourProblems() {'{'} return "Amazing Solutions"; {'}'}</span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                title: "UI/UX Design",
                description: "Designing intuitive and engaging user interfaces and experiences that delight users.",
                icon: "🎨"
              },
              {
              ...
              },
              {
                ...
                description: "Creating efficient and secure database structures for optimal data management.",
                icon: "🗄️"
              },
              {
      ...
      <section className="py-24 bg-gradient-to-b from-black/80 to-black/90 backdrop-blur-md">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">GitHub Activity</h2>
            <p className="text-xl text-white/70">
              Stay updated with my latest code contributions and projects.
              <span className="block mt-2 text-yellow-400 font-mono text-base">git commit -m "Fixed bugs that shouldn't exist in parallel universes"</span>
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-8 text-center">
              <Button asChild variant="outline" className="text-white border-white hover:bg-white hover:text-black">
                <a href="https://github.com/Derrick-MUGISHA" target="_blank" rel="noopener noreferrer" className="flex items-center">
      ...
      <section className="py-24 bg-black/80 backdrop-blur-md">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">My Journey</h2>
            <p className="text-xl text-white/70">
              A timeline of my professional experience and key milestones.
              <span className="block mt-2 text-purple-400 font-mono text-base">{"for (let year = startYear; year <= currentYear; year++) { levelUp(); }"}</span>
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-black/80 to-black/90 backdrop-blur-md">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Client Testimonials</h2>
            <p className="text-xl text-white/70">
              What people say about working with me.
              <span className="block mt-2 text-red-400 font-mono text-base">if (client.isHappy) {'{'} return client.refer(friends); {'}'}</span>
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/70 mb-10">
              ...
              <span className="block mt-2 text-cyan-400 font-mono text-base">await project.start(yourIdea);</span>
            </p>
            <Button asChild size="lg" className="bg-white text-black hover:bg-white/90">
      ...
      <footer className="py-12 bg-black/90 backdrop-blur-md border-t border-white/10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold text-white mb-4">DERRICK MUGISHA</h3>
              <p className="text-white/70 mb-4">
                Full Stack Software Developer specializing in creating exceptional digital experiences.
              </p>
              <div className="flex space-x-4">
                <a href="https://github.com/Derrick-MUGISHA" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white">
                  <Github className="h-5 w-5" />
                </a>
                <a href="https://linkedin.com/in/erichirwa" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white">
                ...
                <a href="https://twitter.com/erichirwa" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/services#web-development" className="text-white/70 hover:text-white transition-colors">
                    Web Development
                  </Link>
                </li>
                <li>
                  <Link href="/services#mobile-development" className="text-white/70 hover:text-white transition-colors">
                    Mobile Development
                  </Link>
                </li>
                <li>
                  <Link href="/services#ui-ux-design" className="text-white/70 hover:text-white transition-colors">
                    UI/UX Design
                  </Link>
                </li>
                <li>
                  <Link href="/services#backend-development" className="text-white/70 hover:text-white transition-colors">
                    Backend Development
                  </Link>
                </li>
                <li>
                  <Link href="/services#database-design" className="text-white/70 hover:text-white transition-colors">
                    Database Design
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-white/70">
                  Email: <a href="mailto:hello@erichirwa.com" className="hover:text-white transition-colors">derrickmugisha169@gmail.com</a>
                </li>
                <li className="text-white/70">
